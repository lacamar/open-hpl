...
cAmfpDebugFreeCamera::cAmfpDebugFreeCamera(cCamera *apCamera, cInput *apInput) : iUpdateable("AmfpDebugFreeCamera")
{
	mpCamera = apCamera;
	mpInput = apInput;
...
cAmfpDebugFreeCamera::~cAmfpDebugFreeCamera()
{
}

//-----------------------------------------------------------------------

void cAmfpDebugFreeCamera::Update(float afTimeStep)
{
