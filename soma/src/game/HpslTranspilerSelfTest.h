 ...
 *
 * Covers seven real files as of this pass: clear_vtx/clear_frag (the
 * original proof-of-concept pair), null_vtx/null_frag, and three
 ...
 * the px_vPosition->gl_Position/gl_FragCoord convention).
 *
